...
// gv_solvels
List gv_solvels(NumericMatrix rA, NumericVector rb, NumericVector rvar_b);
RcppExport SEXP gRavity_gv_solvels(SEXP rASEXP, SEXP rbSEXP, SEXP rvar_bSEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        Rcpp::RNGScope __rngScope;
        ...
        Rcpp::traits::input_parameter< NumericVector >::type rvar_b(rvar_bSEXP );
        List __result = gv_solvels(rA, rb, rvar_b);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
